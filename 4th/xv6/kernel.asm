...
8010364e:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 60; // Default priority
80103655:	c7 43 7c 3c 00 00 00 	movl   $0x3c,0x7c(%ebx)
  p->pid = nextpid++;
...
801037ba:	68 e4 76 10 80       	push   $0x801076e4
...
80104088:	8b 14 85 30 77 10 80 	mov    -0x7fef88d0(,%eax,4),%edx
      state = "???";
...
80104112:	e8 09 03 00 00       	call   80104420 <acquire>
    cprintf("name \t pid \t state \t \t priority \n");
80104117:	c7 04 24 0c 77 10 80 	movl   $0x8010770c,(%esp)
...
8010419a:	68 86 76 10 80       	push   $0x80107686
...
801041ba:	68 9e 76 10 80       	push   $0x8010769e
...
8010422a:	68 48 77 10 80       	push   $0x80107748
...
801044cb:	68 53 77 10 80       	push   $0x80107753
...
80104525:	68 5b 77 10 80       	push   $0x8010775b
8010452a:	e8 61 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010452f:	83 ec 0c             	sub    $0xc,%esp
80104532:	68 72 77 10 80       	push   $0x80107772
...
8010455d:	68 79 77 10 80       	push   $0x80107779
...
801049d0:	68 81 77 10 80       	push   $0x80107781
...
80105864:	66 a3 86 4b 11 80    	mov    %ax,0x80114b86
  initlock(&tickslock, "time");
8010586a:	e8 c1 ea ff ff       	call   80104330 <initlock>
}
...
80105ad8:	e8 43 e9 ff ff       	call   80104420 <acquire>
      wakeup(&ticks);
...
80105af7:	e8 44 ea ff ff       	call   80104540 <release>
...
80106a69:	5d                   	pop    %ebp
  popcli();
80106a6a:	e9 71 da ff ff       	jmp    801044e0 <popcli>
...
80106ed3:	e8 78 d7 ff ff       	call   80104650 <memmove>
...
80106f25:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106f2b:	e8 a0 b5 ff ff       	call   801024d0 <kalloc>
...
80106f57:	68 5c 7a 10 80       	push   $0x80107a5c
80106f5c:	e8 2f 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80106f61:	83 ec 0c             	sub    $0xc,%esp
80106f64:	68 76 7a 10 80       	push   $0x80107a76
